  ...
  return (
    <section id="testimonials" className="py-24 md:py-32 bg-white" ref={ref}>
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-warm-gray">
          {reviews.map((r, i) => (
            <div
              key={r.name}
              className={`animate-on-scroll delay-${i * 200} bg-white p-8 md:p-10 flex flex-col gap-5`}
            >
              <Stars count={r.rating} />

              <blockquote className="font-sans text-navy/70 text-sm leading-relaxed flex-1 italic">
                "{r.text}"
              </blockquote>
