    ...
    >
        ...
        <nav className="hidden md:flex items-center gap-8">
          {links.map((l) => (
            <a
              key={l.href}
              href={l.href}
              className="font-sans text-sm font-medium text-navy/70 hover:text-navy transition-colors duration-200 tracking-wide"
            >
              {l.label}
            </a>
          ))}
          <a
            href="#contact"
            className="ml-2 px-5 py-2.5 bg-navy text-cream font-sans text-sm font-medium tracking-wide hover:bg-navy/80 transition-colors duration-200"
          >
            Pierakstīties
          </a>
        </nav>
      ...
      {open && (
        <div className="md:hidden bg-cream border-t border-warm-gray px-6 py-6 flex flex-col gap-5">
          ...
          <a
            href="#contact"
            className="mt-2 px-5 py-3 bg-navy text-cream font-sans text-sm font-medium text-center tracking-wide"
            onClick={() => setOpen(false)}
          >
            Pierakstīties
          </a>
